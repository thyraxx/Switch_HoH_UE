...
%endif
	...
	// Copiado de BaseGameMode.as el 14/01/2019///////////////////////////////////////////////////////////////////////////////
	Widget@ FirstFocusable(Widget@ w)
	{
		if (w.m_canFocus && !w.m_invalidated) //Cambiado el 11/01/2019, agregada la condicion de visibilidad//////////////////////
			return w;
		...
		for (uint i = 0; i < w.m_children.length(); i++)
		{
			...
			if (ww.m_canFocus && !ww.m_invalidated) //Cambiado el 11/01/2019, agregada la condicion de visibilidad////////////////
				return ww;
