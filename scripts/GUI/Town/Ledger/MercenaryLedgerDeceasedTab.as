class MercenaryLedgerDeceasedTab : MenuTab
{
	...
	void Update(int dt) override
	{
		...
		{
			int index = m_wList.m_children.findByRef(g_gameMode.m_widgetUnderCursor);
			if(index != 1)
			{
				index = (index + 1)/2;
				...
				g_gameMode.ShowDialog("delete-confirm " + index,
					"are you sure you want to permanently remove " + charName + " from the ledger as well as the graveyard?",
