class ScrollbarWidget : Widget
{
	...
	vec2 m_prevMouse; ///////////////////////////////////////////////////////Agregado 17/01/2019
	bool m_forceUp;
	bool m_forceHandle;
	bool m_forceDown;
	...
	void Load(WidgetLoadingContext &ctx) override
	{
		...
		m_buttonsSize = 0;//ctx.GetInteger("buttons-size", false, 8);
		m_troughOffset = m_buttonsSize + 4;//ctx.GetInteger("trough-offset", false, m_buttonsSize);
	...
	{
		if (mousePos.y > m_troughOffset + m_handleY && mousePos.y < m_troughOffset + m_handleY + m_handleSize && mousePos.x > 0 && mousePos.x < m_width) ///Agregado criterio en el eje x
		{
...
//////////////////////////// Agregado condicion y variable m_prevMouse///////////////////////////////////
		if(m_prevMouse.x != mousePos.x && m_prevMouse.y != mousePos.y ) 
		{
			m_forceUp = false;
			m_forceHandle = false;
			m_forceDown = false;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////	
		...
		m_buttonUpHover = ((m_hovering && mousePos.y < m_troughOffset) && !m_forceDown && ! m_forceHandle) || m_forceUp;
		m_buttonDownHover = ((m_hovering && mousePos.y > m_height - m_troughOffset) && !m_forceUp && ! m_forceHandle) || m_forceDown;
		m_handleHover =  ((m_overHandle ||
						 (m_hovering &&
						  mousePos.y > m_troughOffset + m_handleY &&
						  mousePos.y < m_troughOffset + m_handleY + m_handleSize))
		                  && !m_forceUp && !m_forceDown) || m_forceHandle;
	}

	//////////////////////////////////////Agregado 17/01/2019////////////////////////////////////////////////////////////////////////////
	// Returns whether focus was changed. If this returns true, the previous widget will be unfocused.
	//*
	bool FocusTowards(WidgetDirection dir, Widget@ originWidget = null) override
	{
		switch (dir)
		{
		...
		return Widget::FocusTowards(dir, originWidget);				
	}
	//*/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
