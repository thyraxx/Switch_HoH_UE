namespace Menu
{
	class CharacterCreationMenu : HwrMenu
	{
		...
		void OnFunc(Widget@ sender, string name) override
		{
			...
			{
				if(m_wMercenary.IsChecked() && HwrSaves::GetNumMercs() >= g_maxMercs)
					g_gameMode.ShowDialog("toomanymerchs", "Too many mercenaries created. Delete a deceased mercenary at the Company Ledger and try again.", Resources::GetString(".menu.ok"), null);
				else
