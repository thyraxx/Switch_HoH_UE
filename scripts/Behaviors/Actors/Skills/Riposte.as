namespace Skills
{
	class RiposteTrigger : Modifiers::Modifier
	{
		...
		{
			@m_skill = skill;
			m_triggerEffects = uint(Modifiers::EffectTrigger::Attack);
		}

		Modifiers::ModDyn DynUpdate() override { return Modifiers::ModDyn::Dynamic; }
		...
		Modifiers::ModDyn DynDamageBlockMul() override { return Modifiers::ModDyn::Dynamic; }
