namespace Skills
{
	class StackDamageTrigger : Modifiers::Modifier
	{
		...
		{
			@m_skill = skill;
			m_triggerEffects = uint(Modifiers::EffectTrigger::Hit);
		}
		...
		Modifiers::ModDyn DynAttackDamageAdd() override { return Modifiers::ModDyn::Dynamic; }
		...
		Modifiers::ModDyn DynSpellDamageAdd() override { return Modifiers::ModDyn::Dynamic; }
