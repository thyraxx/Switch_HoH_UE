namespace Modifiers
{
	class SealOfGeneric : Modifier
	{
		...
		ModDyn DynMoveSpeedMul() override { return (m_movementMul != 0) ? ModDyn::Dynamic : ModDyn::None; }
		...
		ModDyn DynSkillTimeMul() override { return (m_skillSpeedMul != 0) ? ModDyn::Dynamic : ModDyn::None; }
		ModDyn DynAttackTimeMul() override { return (m_attackSpeedMul != 0) ? ModDyn::Dynamic : ModDyn::None; }
