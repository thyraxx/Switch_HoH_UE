namespace Modifiers
{
	class Markham : Modifier
	{
		...
		ModDyn DynStatsAdd() override { return (m_stats.x != 0 || m_stats.y != 0) ? ModDyn::Dynamic : ModDyn::None; }
		ModDyn DynDamageMul() override { return (m_damageMulAdd.x != 0 || m_damageMulAdd.y != 0) ? ModDyn::Dynamic : ModDyn::None; }
		ModDyn DynDamagePower() override { return (m_power.x != 0 || m_power.y != 0) ? ModDyn::Dynamic : ModDyn::None; }
		ModDyn DynArmorAdd() override { return (m_armor.x != 0 || m_armor.y != 0) ? ModDyn::Dynamic : ModDyn::None; }

		ModDyn DynOreGainScale() override { return m_oreScale != 0 ? ModDyn::Dynamic : ModDyn::None; }
		ModDyn DynGoldGainScale() override { return m_goldScale != 0 ? ModDyn::Dynamic : ModDyn::None; }
		ModDyn DynSkillTimeMul() override { return m_skillMul != 0 ? ModDyn::Dynamic : ModDyn::None; }
		ModDyn DynAttackTimeMul() override { return m_attackMul != 0 ? ModDyn::Dynamic : ModDyn::None; }
