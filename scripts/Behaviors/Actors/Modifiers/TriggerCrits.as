namespace Modifiers
{
	class TriggerCrits : Modifier, IBuffWidgetInfo
	{
		...
		TriggerCrits(UnitPtr unit, SValue& params)
		{
			...
			m_triggerEffects = uint(EffectTrigger::CastSpell);
		}
		...
		ModDyn DynCrit() override { return ModDyn::Dynamic; }
		...
		ModDyn DynUpdate() override { return ModDyn::Dynamic; }
		...
		ModDyn DynTriggerEffects() override { return ModDyn::Dynamic; }
