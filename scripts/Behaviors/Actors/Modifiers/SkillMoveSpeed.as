namespace Modifiers
{
	class SkillMoveSpeed : Modifier
	{
		...
		ModDyn DynSkillMoveSpeedMul() override { return (m_mul != 1.0f) ? ModDyn::Dynamic : ModDyn::None; }
		...
		ModDyn DynSkillMoveSpeedClear() override { return m_clear ? ModDyn::Dynamic : ModDyn::None; }
