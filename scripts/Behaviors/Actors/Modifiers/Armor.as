namespace Modifiers
{
	class Armor : Modifier
	{
		...
		ModDyn DynArmorAdd() override { return (m_armor.x != 0 || m_armor.y != 0) ? ModDyn::Static : ModDyn::None; }
		ModDyn DynArmorMul() override { return (m_armorMul.x != 1.0f || m_armorMul.y != 1.0f) ? ModDyn::Static : ModDyn::None; }
		ModDyn DynDamageTakenMul() override { return m_dmgTakenMul != 1.0f ? ModDyn::Static : ModDyn::None; }
