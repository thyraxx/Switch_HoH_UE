namespace Modifiers
{
	class Combo : FilterModifier
	{
		...
		ModDyn DynComboEffects() override { return m_effects !is null ? ModDyn::Dynamic : ModDyn::None; }
		...
		ModDyn DynComboProps() override { return (m_props.x != 0 || m_props.y != 0 || m_props.z != 0) ? ModDyn::Static : ModDyn::None; }
