...
%if CONSOLE
		for (uint i = 0; i < enemyPlacer.m_enemyTypes.length(); i++)
		{
			enemyPlacer.m_enemyTypes[i].m_numScale *= 0.25f;
			enemyPlacer.m_enemyTypes[i].m_baseEnemyCount = max(1, enemyPlacer.m_enemyTypes[i].m_baseEnemyCount -1);
